...
export default function CategorySections() {
  ...
  return (
    <div className="bg-stone-100 text-white min-h-screen">
      {/* Hero Quote Section with Parallax - Removed top padding */}
      <div 
        className="w-full relative overflow-hidden py-8 flex items-center justify-center"
        style={{
      ...
      {/* Treatment Cards with Advanced Hover Effects - Removed negative margin */}
